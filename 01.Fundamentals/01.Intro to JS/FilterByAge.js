function filterByAge([minAge, firstName, firstAge, secondName, secondAge]) {
    ...
    if (firstPerson.age >= Number(minAge)) console.log(firstPerson);
    if (secondPerson.age >= Number(minAge)) console.log(secondPerson);
}

filterByAge(['25','Boryana','23','Ludovic','27']);